...
import com.huawei.hms.location.backend.providers.ActivityIdentificationProvider;
import com.huawei.hms.location.cordova.helpers.CordovaCallback;
import com.huawei.hms.location.cordova.helpers.CordovaUtils;
import com.huawei.hms.location.cordova.helpers.HMSCordovaPlugin;
...
public class HMSActivityIdentification extends HMSCordovaPlugin {
    ...
    public void pluginInitialize() {
        provider = CordovaUtils.initializeProvider(new ActivityIdentificationProvider(cordova.getContext()), cordova, this);
    }
