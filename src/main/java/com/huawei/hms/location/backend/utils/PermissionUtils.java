...
public class PermissionUtils {
    ...
    public static boolean hasActivityRecognitionPermission(HMSProvider provider) {
        return
            (Build.VERSION.SDK_INT <= Build.VERSION_CODES.P && provider.hasPermission("com.huawei.hms.permission.ACTIVITY_RECOGNITION"))
                || (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P && provider.hasPermission("android.permission.ACTIVITY_RECOGNITION"));
    }
    ...
    public static final TriMapper<Integer, String[], int[], JSONObject> HANDLE_PERMISSION_REQUEST_RESULT = triMapperWrapper((requestCode, permissions, grantResults) -> {
